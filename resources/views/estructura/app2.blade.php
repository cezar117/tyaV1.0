...
<html lang="{{ config('app.locale') }}" class="firefox">
    <head>
        ...
        <link href="{{ asset('css/materialize/materialize.css') }}" type="text/css" rel="stylesheet" media="screen,projection">
        <link href="{{ asset('css/materialize/style.css') }}" type="text/css" rel="stylesheet" media="screen,projection">
        ...
        <nav class="white principal" role="navigation">
            <div class="nav-wrapper container">
                <a id="logo-container" href="{{ route('home') }}" class="brand-logo">
                    <img border="0" alt="TripYa" src="{{asset('images/logo-10.png')}}" style="width: 140px; height: 55px; padding-top: 5px;"></a>
