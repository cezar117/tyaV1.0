...
<div class="card-panel blue lighten-5">
         <div class="form-group form-float">
           ...
           <h4>TOTAL : <br><b>$<span id="total" class="red lighten-1" style="background-color: grey lighten-4">{{obtenerTotalCarrito()}}
           </span></b>
           </h4>
        ...
        <div class="card white darken-1 hoverable" id="{{$key}}">
            <div class="card-content black-text">
                ...
                @if($elemento["tipo"] == 'Tour')
                    <img src="{{$elemento["datos"]->Imagen}}" class="imagenListadoCarrito materialboxed ">
                   
                    @elseif($elemento["tipo"] == 'Actividad')
                    <img src="{{$elemento["datos"]->Galeria->Imagen->Nombre}}" class="imagenListadoCarrito materialboxed ">
                  @else
                     <img src="{{$elemento["datos"]->Imagen_main}}" class="imagenListadoCarrito materialboxed ">
                 @endif   
                </div>
                <div class="col s9 m9 l9">
