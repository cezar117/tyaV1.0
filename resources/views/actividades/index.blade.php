...
<div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
        ...
        <div class="buscadores">
            <h4 class="">Buscar Actividades</h4>
            <div class="row">
                <div class="contenidoBuscadores">
                    @include('actividades.componenteBusquedaActividades',["from"=>"buscadores"])
                </div>
            </div>
        </div>
    </div>
    <div class="parallax"><img src="{{ asset('images/background11.jpg') }}" alt="Unsplashed background img 1"></div>
</div>
