<div class="">
    <form action="{{ route('circuitos.busqueda') }}" method="POST" name="form">
        <div class="form-group form-float">
            <div class="form-line">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        ...
                        <div class="col s12 @if($from === 'resultados') m12 @else m8 @endif divDestinos">
                            <select id="selectDestino" name="destino" class="selectDestino form-control" style="width: 100%">
                ...
                <div class="input-field col s6 @if($from === 'resultados') m6 @else m4 @endif">
                    ...
                    <div class="row">
                        <select id="adultos" class="browser-default form-control" name="adultos">
                ...
                <div class="col s12 @if($from === 'resultados') m12 @else m8 @endif">
                    <div class="row"><span for="fecha" class="active">Fecha inicio</span></div>
