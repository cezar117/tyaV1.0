...
//        $peticion->Nights;
    ...
    public function obtenerHoteles2($IdSession, $categoria = null, $fechaEntrada, $fechaSalida, $idHotel = 0, $idDestino = 0, $habitaciones = array(), $productoParaGrupo = 0) {
        $respuesta = new stdclass();
        $respuesta->tipo = 0;
        ...
        if($idHotel==="" || $idHotel==="0")$idHotel=0;
        if($idHotel!==0){
        ...
        //$peticion->ProductoDeGrupo = $productoPaaGrupo;
        $busquedaPorGrupo="";
        switch ($productoParaGrupo) {
            case -1:
                $busquedaPorGrupo="TODO";
                break;
            case 0:
                $busquedaPorGrupo="SIN_GRUPO";
                break;
            case 1:
                $busquedaPorGrupo="GRUPO";
                break;    
            default:
                break;
        }
        
        $peticion->ProductoDeGrupo=new SoapVar($busquedaPorGrupo, SOAP_ENC_OBJECT, "busquedaPorGrupo", "http://schemas.datacontract.org/2004/07/Serviciob2b");
    ...
    public function ObtenerTours2($idSession, $adultos, $menores, $edadMenores = array(), $idTour=0, $idDestino, $tipoServicio, $idioma, $fecha, $tipo = null, $servicioTipo = null) {
        ...
        switch ($tipoServicio) {
            case 0:
                $tipoServicioStr="PRIVADO";
                break;
            case 1:
                $tipoServicioStr="COMPARTIDO";
                break;    
            default:
                break;
        }
        
        $peticion->TipoServicio=new SoapVar($tipoServicioStr, SOAP_ENC_OBJECT, "tipoServicio", "http://schemas.datacontract.org/2004/07/Serviciob2b");

        $peticion->Idioma = $idioma;

        $tipoDeBusqueda= new stdclass();
        $stringTipoDeBusqueda="";
        if($idTour==="" || $idTour==="0")$idTour=0;
        if($idTour!==0){
            $stringTipoDeBusqueda="PRODUCTO";
    ...
    public function obtenerCircuitos2($idSession, $fechaInicio, $idDestino, $idCircuito=0, $idioma, $tipoCircuito = 0, $tipoServicio = 1, $grupo = array()) {
        $respuesta = new stdclass();
        $respuesta->tipo = 0;
        ...
        switch ($tipoServicio) {
            case -1:
                $tipoCircuitoStr="NO_APLICA";
                break;
            case 0:
                $tipoCircuitoStr="TERRESTRE";
                break;
            case 1:
                $tipoCircuitoStr="CON_HOTEL";
                break;    
            default:
                break;
        }
        
        $peticion->TipoCircuito=new SoapVar($tipoCircuitoStr, SOAP_ENC_OBJECT, "tipoCircuito", "http://schemas.datacontract.org/2004/07/Serviciob2b");
        ...
        $tipoDeBusqueda= new stdclass();
        $stringTipoDeBusqueda="";
        if($idCircuito==="" || $idCircuito==="0")$idCircuito=0;
        if($idCircuito!==0){
            $stringTipoDeBusqueda="PRODUCTO";
    ...
    public function ObtenerActividades2($idSession, $adultos, $menores, $edadMenores = array(), $idActividad=0, $idDestino, $tipoServicio, $idioma, $fecha, $tipo = null, $servicioTipo = null) {
        ...
        $tipoDeBusqueda= new stdclass();
        $stringTipoDeBusqueda="";
        if($idActividad==="" || $idActividad==="0")$idActividad=0;
        if($idActividad!==0){
            $stringTipoDeBusqueda="PRODUCTO";
